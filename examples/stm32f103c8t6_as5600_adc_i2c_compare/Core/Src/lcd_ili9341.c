...
{
  /*
   * LCD_DrawChar() converts lowercase text to uppercase before lookup.
   * Unsupported glyphs used to render as blank; keep this table in sync with
   * UI text, and fall back to '?' so missing glyphs are visible during testing.
   */
  switch (c)
  {
    case ' ': { static const uint8_t g[7]={0x00,0x00,0x00,0x00,0x00,0x00,0x00}; return g[r]; }
    case 'A': { static const uint8_t g[7]={0x0E,0x11,0x11,0x1F,0x11,0x11,0x11}; return g[r]; }
    case 'B': { static const uint8_t g[7]={0x1E,0x11,0x11,0x1E,0x11,0x11,0x1E}; return g[r]; }
    case 'C': { static const uint8_t g[7]={0x0E,0x11,0x10,0x10,0x10,0x11,0x0E}; return g[r]; }
    ...
    case 'F': { static const uint8_t g[7]={0x1F,0x10,0x10,0x1E,0x10,0x10,0x10}; return g[r]; }
    case 'G': { static const uint8_t g[7]={0x0E,0x11,0x10,0x17,0x11,0x11,0x0E}; return g[r]; }
    case 'H': { static const uint8_t g[7]={0x11,0x11,0x11,0x1F,0x11,0x11,0x11}; return g[r]; }
    case 'I': { static const uint8_t g[7]={0x1F,0x04,0x04,0x04,0x04,0x04,0x1F}; return g[r]; }
    case 'J': { static const uint8_t g[7]={0x01,0x01,0x01,0x01,0x11,0x11,0x0E}; return g[r]; }
    case 'K': { static const uint8_t g[7]={0x11,0x12,0x14,0x18,0x14,0x12,0x11}; return g[r]; }
    ...
    case 'Q': { static const uint8_t g[7]={0x0E,0x11,0x11,0x11,0x15,0x12,0x0D}; return g[r]; }
    ...
    case 'W': { static const uint8_t g[7]={0x11,0x11,0x11,0x15,0x15,0x15,0x0A}; return g[r]; }
    case 'X': { static const uint8_t g[7]={0x11,0x11,0x0A,0x04,0x0A,0x11,0x11}; return g[r]; }
    case 'Y': { static const uint8_t g[7]={0x11,0x11,0x0A,0x04,0x04,0x04,0x04}; return g[r]; }
    case 'Z': { static const uint8_t g[7]={0x1F,0x01,0x02,0x04,0x08,0x10,0x1F}; return g[r]; }
    ...
    case '.': { static const uint8_t g[7]={0x00,0x00,0x00,0x00,0x00,0x0C,0x0C}; return g[r]; }
    case ',': { static const uint8_t g[7]={0x00,0x00,0x00,0x00,0x0C,0x04,0x08}; return g[r]; }
    case '?': { static const uint8_t g[7]={0x0E,0x11,0x01,0x02,0x04,0x00,0x04}; return g[r]; }
    case '!': { static const uint8_t g[7]={0x04,0x04,0x04,0x04,0x04,0x00,0x04}; return g[r]; }
    case '<': { static const uint8_t g[7]={0x02,0x04,0x08,0x10,0x08,0x04,0x02}; return g[r]; }
    case '>': { static const uint8_t g[7]={0x08,0x04,0x02,0x01,0x02,0x04,0x08}; return g[r]; }
    case '/': { static const uint8_t g[7]={0x01,0x01,0x02,0x04,0x08,0x10,0x10}; return g[r]; }
    case '(': { static const uint8_t g[7]={0x02,0x04,0x08,0x08,0x08,0x04,0x02}; return g[r]; }
    case ')': { static const uint8_t g[7]={0x08,0x04,0x02,0x02,0x02,0x04,0x08}; return g[r]; }
    case '=': { static const uint8_t g[7]={0x00,0x00,0x1F,0x00,0x1F,0x00,0x00}; return g[r]; }
    case '_': { static const uint8_t g[7]={0x00,0x00,0x00,0x00,0x00,0x00,0x1F}; return g[r]; }
    ...
    default:  { static const uint8_t g[7]={0x0E,0x11,0x01,0x02,0x04,0x00,0x04}; return g[r]; }
  }
}
